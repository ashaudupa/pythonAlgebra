...
num_hours = 24
num_minutes = 60
minutes_in_week = num_days * num_hours * num_minutes
...
list_sum_zip = [x+y for (x,y) in list(zip(A,B))]
...
representation_dict = {i*base**2 + j*base+k:(i,j,k) for i in digits for k in digits for j in digits}
